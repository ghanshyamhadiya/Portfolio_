...
// Optimized ProfileImage with simplified animations
...
const GlowBackground = memo(() => (
  <div className="absolute inset-0 overflow-hidden">
    ...
    <div className="absolute top-1/3 right-1/4 w-1/3 h-1/3 rounded-full bg-purple-600/10 filter blur-[120px]" />
  </div>
));
    ...
    >
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12">
          ...
          >
            <motion.div
              className="inline-block p-2 px-4 rounded-full bg-gradient-to-r from-indigo-900/30 to-purple-900/30 border border-indigo-500/20 backdrop-blur-sm mb-4 md:mb-6"
              custom={0}
        ...
        <motion.div 
          className="absolute bottom-6 md:bottom-10 left-1/2 transform -translate-x-1/2 text-gray-400"
        ...
        >
          <motion.a
            href="#about"
            className="p-2 rounded-full bg-gray-900/50 backdrop-blur-sm border border-gray-800 inline-block"
            animate={{ y: [0, 5, 0] }}
